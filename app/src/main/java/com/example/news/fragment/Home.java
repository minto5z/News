...
public class Home extends Fragment implements NewsAdapter.ClickListener {

    private RecyclerView recyclerView;
    private NewsAdapter adapter;
    private HomeViewModel viewModel;
    private List<News> homeData;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        viewModel.homeLiveData.observe(getViewLifecycleOwner(), new Observer<Response<List<News>>>() {
            @Override
    ...
    public void onItemClick(int position) {
        Uri uri = Uri.parse(homeData.get(position).getUrl());
